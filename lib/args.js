...
function args(argv) {
  var opts = subarg(argv, {
    string: ['reporter', 'ui', 'chrome', 'phantomjs', 'consolify', 'timeout',
      'port', 'yields', 'transform', 'plugin', 'grep', 'url', 'require',
      'extension', 'web-security', 'bundle', 'wd-file', 'path', 'external',
      'viewport-width', 'viewport-height', 'outfile'],
