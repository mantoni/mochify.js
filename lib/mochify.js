...
module.exports = function (_, opts) {
  ...
  var brOpts = opts['browserify-options'] || {};
  brOpts.debug = true;
  brOpts.cache = {};
  brOpts.packageCache = {};
  ...
  if (opts.node) {
    ...
    brOpts.insertGlobalVars = brOpts.insertGlobalVars || [];
    brOpts.insertGlobalVars = brOpts.insertGlobalVars.concat(['__dirname', '__filename']);
  }
